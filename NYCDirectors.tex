...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=0.38]{images/guarantry-bipartite.png}
	\end{center}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[scale=0.38]{images/elites.png}
	\end{center}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.7\textwidth]{images/firm-value-industry.png}
